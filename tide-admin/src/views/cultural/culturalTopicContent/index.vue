  ...
  <div class="app-container">
    ...
    <el-form :model="queryParams"
      ...
      <el-form-item label="文化专题"
                    prop="culturalTopicId">
        <el-input v-model="queryParams.culturalTopicId"
                  placeholder="请输入文化专题"
                  clearable
    ...
    <el-row :gutter="10"
      ...
      <el-col :span="1.5">
        <el-button type="primary"
                   ...
                   icon="Plus"
                   @click="handleAdd"
                   v-hasPermi="['cultural:culturalTopicContent:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success"
                   ...
                   :disabled="single"
                   @click="handleUpdate"
                   v-hasPermi="['cultural:culturalTopicContent:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger"
                   ...
                   :disabled="multiple"
                   @click="handleDelete"
                   v-hasPermi="['cultural:culturalTopicContent:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning"
                   ...
                   icon="Download"
                   @click="handleExport"
                   v-hasPermi="['cultural:culturalTopicContent:export']">导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading"
      ...
      <el-table-column label="id"
                       align="center"
                       prop="id" />
      <el-table-column label="文化专题id"
                       align="center"
                       prop="culturalTopicId" />
      <el-table-column label="标签id1"
                       align="center"
                       prop="tagId1" />
      <el-table-column label="标签id2"
                       align="center"
                       prop="tagId2" />
      <el-table-column label="标签id3"
                       align="center"
                       prop="tagId3" />
    ...
    <el-dialog :title="title"
               ...
               width="500px"
               append-to-body>
      <el-form ref="culturalTopicContentRef"
               :model="form"
               :rules="rules"
               label-width="80px">
        <el-form-item label="文化专题"
                      prop="culturalTopicId">
          <el-input v-model="form.culturalTopicId"
                    placeholder="请选择文化专题" />
        </el-form-item>
        ...
        <el-form-item label="标签1"
                      prop="tagId1">
          <el-input v-model="form.tagId1"
                    placeholder="请输入标签id1" />
        </el-form-item>
        <el-form-item label="标签2"
                      prop="tagId2">
          <el-input v-model="form.tagId2"
                    placeholder="请输入标签id2" />
        </el-form-item>
        <el-form-item label="标签3"
                      prop="tagId3">
          <el-input v-model="form.tagId3"
...
function handleSwitchChange(row) {
  console.log("row:", row);
  updateCulturalTopicContent(row).then((response) => {
